...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  Wire.beginTransmission(address);
  Wire.write(reg);
  Wire.write(static_cast<int>((value >> 24) & 0xFF)); // value highest byte
  Wire.write(static_cast<int>((value >> 16) & 0xFF));
  Wire.write(static_cast<int>((value >>  8) & 0xFF));
  Wire.write(static_cast<int>( value        & 0xFF)); // value lowest byte
  last_status = Wire.endTransmission();
}
